...
export default function CreateGamePage() {
    ...
    async function createNewGame(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            const newGame = await axios.post(`http://127.0.0.1:5001/colour-matcher-2e7cd/us-central1/createGame`, newGameData, { //http://127.0.0.1:5001/colour-matcher-2e7cd/us-central1/createGame  ${process.env.newGame}
                headers: {
    ...
    async function joinNewGame(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            const newGame = await axios.post(`http://127.0.0.1:5001/colour-matcher-2e7cd/us-central1/createGame`, newGameData, {
                headers: {
                    "Content-Type": "application/json"
                }
            });
